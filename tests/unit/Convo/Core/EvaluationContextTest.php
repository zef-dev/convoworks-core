...
class EvaluationContextTest extends TestCase
{
	...
	/**
	 * @dataProvider stringParsingProviderWithHashTags
	 * @param string $expected
	 * @param string $string
	 * @param mixed $context
	 */
	public function testStringParsingWorksWithHashTags($expected, $string, $context)
	{
		$context = new ArrayResolver($context);
		$actual = $this->_evalContext->evalString($string, $context->getValues(), false, true);
	...
	/**
	 * @dataProvider stringParsingProviderObjectsWithHashTags
	 * @param string $expected
	 * @param string $string
	 * @param mixed $context
	 */
	public function testStringParsingFromObjectsWorksWithHashTags($expected, $string, $context)
	{
		$ctx = new ArrayResolver([
			'request' => new ObjectResolver($context)
		]);

		$actual = $this->_evalContext->evalString($string, $ctx->get(), false, true);
	...
	/**
	 * @dataProvider arrayParsingProviderWithHashTags
	 * @param array $expected
	 * @param array $array
	 * @param mixed $context
	 */
	public function testArrayParsingWorksWithHashTags($expected, $array, $context)
	{
		$this->_logger->debug('-------------');
		$context = new ArrayResolver($context);

		$actual = $this->_evalContext->evalArray($array, $context->getValues(), true);
	...
	public function arrayParsingProviderWithHashTags()
	{
		return [
			[
				[
	...
	public function stringParsingProviderWithHashTags()
	{
		return [
			'Hello world' => [
				'Hello world',
	...
	public function stringParsingProviderObjectsWithHashTags()
	{
		return [
			'Japanese UTF-8' => [
				'ć—Ąćś¬čŞžă�Żă‚Źă�‹ă‚Šă�ľă�™',
